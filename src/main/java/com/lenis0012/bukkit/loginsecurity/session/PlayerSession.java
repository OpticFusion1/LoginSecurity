...
public class PlayerSession {
    ...
    /**
     * Check whether the player has an account and is logged in. Note: You're probably looking for {@link #isAuthorized() isAuthorized}.
     *
     * @return Logged in
     */
    ...
    /**
     * Check whether or not the player's auth mode is "AUTHENTICATED". This means they're allowed to move etc. Returns true when player is logged in OR password is not required and player has no account.
     *
     * @return Authorized
     */
    ...
    /**
     * Perform an action in an async task. Runs callback when action is finished.
     *
